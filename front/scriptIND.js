...
<Switch>
    <Route path="/" exact component={Edificio} />
...
class NoMatch extends React.Component {
    render() {
        return(
            <h1 className="titulo-mensaje-error" >Error 404 - Not found</h1>
        )
    }
}
...
class Contacto extends React.Component{
    render(){
        return (
            <div className="page-nav-contacto">
<ul>
    <li>Tienda@unmail.com</li>
    <li>0800-555-TIENDA</li>
    ...
    renderProdu(){
        ...
        if (this.state.productoInd != null ){
            ...
            <div className="product-container">
                <h3>{this.state.productoInd.nombre}</h3>
                <a href={"productoIND.html?id="+this.props.id}>
                <img className="imagen-product" src={this.state.productoInd.imagenes} alt={this.state.productoInd.descripcion}></img>
                </a>
            <div className="precio">
                <p className="precio">{this.state.productoInd.precio}</p>
            </div>
...
<div className="product-container">
    ...
    <img clasName="imagen-product"src={this.props.imagenes} alt={this.props.descripcion}></img>
    <div className="precio">
        <p className="precio">{this.props.precio}</p>
    </div>
    <div className="descri">
