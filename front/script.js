...
class ListarProductos extends React.Component{
    ...
    renderList(){
        ...
        return this.state.productos.map((elem) => { 
        return( <Producto
        id = {elem.id}
        descripcion = {elem.descripcion}
        nombre = {elem.nombre}
        imagenes ={elem.imagenes}
        precio = {elem.precio}
        rating = {elem.rating} />
        );});
    }
        ...
        return(
            <div className="product-container">
                ...
                <a href={"productoIND.html?id="+this.props.id}>
                    <img className="imagen-product" src={this.props.imagenes} alt="Imagen no visible"></img>
                </a>
...
class Home extends React.Component {
    render() {
        return(
            <div className="head-mueble">
                <input type="checkbox"/>
            <div>
                <h1>Mueble<span><b>Y</b></span><span><b>E</b></span><span>S</span></h1>
            </div>
            </div>
        )
    }
